...
function proverica1(){
	...
	for (i = 0; i < document.getElementsByClassName("naslov-text").length; i++) {
		document.getElementsByClassName("naslov-text")[i].style.color = "#3e3e3e";
	}

	for (i = 0; i < document.getElementsByClassName("usluge-naslov").length; i++) {
		document.getElementsByClassName("usluge-naslov")[i].style.color = "black";
	}
	for (i = 0; i < document.getElementsByClassName("usluge-txt").length; i++) {
		document.getElementsByClassName("usluge-txt")[i].style.color = "black";
	}
	for (i = 0; i < document.getElementsByClassName("usluge-blok").length; i++) {
		document.getElementsByClassName("usluge-blok")[i].style.boxShadow = "5px 5px 10px #c2c2c2";
	}
	document.getElementsByClassName("nama-text")[0].style.color = "black";

	for (i = 0; i < document.getElementsByClassName("proj-naslov").length; i++) {
		document.getElementsByClassName("proj-naslov")[i].style.color = "black";
	}

	for (i = 0; i < document.getElementsByClassName("slide-txt").length; i++) {
		document.getElementsByClassName("slide-txt")[i].style.color = "black";
	}

	for (i = 0; i < document.getElementsByClassName("slide-txt").length; i++) {
		document.getElementsByClassName("slide-txt")[i].style.backgroundColor = "white";
	}
...
function proverica2(){
	...
	for (i = 0; i < document.getElementsByClassName("naslov-text").length; i++) {
		document.getElementsByClassName("naslov-text")[i].style.color = "#e2e2e2";
	}

	for (i = 0; i < document.getElementsByClassName("usluge-naslov").length; i++) {
		document.getElementsByClassName("usluge-naslov")[i].style.color = "#c2c2c2";
	}
	for (i = 0; i < document.getElementsByClassName("usluge-txt").length; i++) {
		document.getElementsByClassName("usluge-txt")[i].style.color = "#e2e2e2";
	}
	for (i = 0; i < document.getElementsByClassName("usluge-blok").length; i++) {
		document.getElementsByClassName("usluge-blok")[i].style.boxShadow = "3px 3px 10px #3e3e3e";
	}
	document.getElementsByClassName("nama-text")[0].style.color = "#c2c2c2";

	for (i = 0; i < document.getElementsByClassName("proj-naslov").length; i++) {
		document.getElementsByClassName("proj-naslov")[i].style.color = "#c2c2c2";
	}

	for (i = 0; i < document.getElementsByClassName("slide-txt").length; i++) {
		document.getElementsByClassName("slide-txt")[i].style.color = "#e2e2e2";
	}


	for (i = 0; i < document.getElementsByClassName("slide-txt").length; i++) {
		document.getElementsByClassName("slide-txt")[i].style.backgroundColor = "#111111";
	}
...
function levo(){
	document.getElementById('window').scrollBy(-300,0);
}
function desno(){
	document.getElementById('window').scrollBy(300,0);
}
...
$(".p1").hover(function(){
  $(".pd1").css("visibility", "visible");
  }, function(){
  $(".pd1").css("visibility", "hidden");
});
$(".p2").hover(function(){
  $(".pd2").css("visibility", "visible");
  }, function(){
  $(".pd2").css("visibility", "hidden");
});

$(".p3").hover(function(){
  $(".pd3").css("visibility", "visible");
  }, function(){
  $(".pd3").css("visibility", "hidden");
});

$(".p4").hover(function(){
  $(".pd4").css("visibility", "visible");
  }, function(){
  $(".pd4").css("visibility", "hidden");
});

$(".p5").hover(function(){
  $(".pd5").css("visibility", "visible");
  }, function(){
  $(".pd5").css("visibility", "hidden");
});
