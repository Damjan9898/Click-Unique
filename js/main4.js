...
for (i = 0; i < document.getElementsByClassName("language").length; i++) {
	...
	for (i = 0; i < document.getElementsByClassName("sveusluge").length; i++) {
		document.getElementsByClassName("sveusluge")[i].style.color = "black";
	}
...
function proverica2(){
	...
	for (i = 0; i < document.getElementsByClassName("language").length; i++) {
		...
		for (i = 0; i < document.getElementsByClassName("sveusluge").length; i++) {
			document.getElementsByClassName("sveusluge")[i].style.color = "#f2f2f2";
		}
